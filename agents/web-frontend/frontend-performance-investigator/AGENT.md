...
description: 'Runtime web-performance specialist for diagnosing Core Web Vitals, Lighthouse'
regressions, layout shifts, long tasks, and slow network paths with Chrome DevTools
MCP.
model: GPT-5
tools:
- codebase
