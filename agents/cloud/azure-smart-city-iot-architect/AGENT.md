...
description: 'Design Azure IoT and Smart City architectures with clear platform engineering'
reasoning, requiring mandatory review of Azure IoT Edge documentation before recommending
edge solutions.
model: GPT-5.3-Codex
tools:
- search
