...
description: 'Runtime accessibility specialist for keyboard flows, focus management,'
dialog behavior, form errors, and evidence-backed WCAG validation in the browser.
model: GPT-5
tools:
- codebase
- search
