...
description: 'Use when building high-agency frontend interfaces with strict design'
taste, calibrated color, responsive layout, and motion rules.
source: open-source (skills)
---
...
This skill was adopted from open-source repository: `skills`

Original location: `antigravity-awesome-skills/skills/design-taste-frontend/SKILL.md`
