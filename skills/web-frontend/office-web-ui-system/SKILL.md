...
description: 'Design and refactor polished office-style web app interfaces for admin,'
adopted: 2026-05-16
internal, and back-office products. Use when an AI agent needs to build or improve
dashboards, stat cards, page heroes, filter/s
...
Design and refactor polished office-style web app interfaces for admin, internal, and back-office products. Use when an AI agent needs to build or improve dashboards, stat cards, page heroes, filter/s

## When to Use

- Use this skill when working on tasks related to office web ui system
...
Original path: office-web-ui-system
