...
description: 'Provides exact migration patterns for React string refs (ref='
version: 1.0.0
...
'Provides exact migration patterns for React string refs (ref="name" + this.refs.name) to React.createRef() in class components. Use this skill whenever migrating string ref usage - including single e

## When to Use

- Use this skill when working on tasks related to react18 string refs
...
Original path: react18-string-refs
