---
name: 'github-release'
description: 'Guides IA through releasing a new version of a GitHub library end-to-end.  Handles'
compatibility: 'requires: gh CLI and git'
SemVer versioning and Keep a Changelog formatting automatically.
---
